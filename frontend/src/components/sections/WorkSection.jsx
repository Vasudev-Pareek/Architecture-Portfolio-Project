  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        // const res = await axios.get("http://localhost:5000/api/projects?category=${category}");
        console.log("cateogry:", category)
        const res = await axios.get(`http://localhost:5000/api/projects/all?category=${category}`);
